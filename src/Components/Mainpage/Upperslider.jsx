  ...
  return (
    <div className="mainuppersliderprnt h-screen w-screen relative">
      ...
      {sidebigavbar ? (
          ...
          <div className=" flex-grow flex border-b-2 border-white px-4 md:px-8 py-4  ">
            <div className=" flex flex-col justify-between flex-grow">
              <div className="">
                ...
                <div>
                  <img
                    src="./assets/sidenavlogo.png"
                    alt="topImg"
                    className="py-2"
                  />
                </div>
                <div className=" flex flex-col p-2 justify-between items-start gap-3">
                  <p className="text-white text-base sm:text-lg md:text-xl lg:text-2xl hover:text-[#D29A5A]">
                    HOME
                  </p>
                  <p className="text-white text-base sm:text-lg md:text-xl lg:text-2xl hover:text-[#D29A5A] ">
                    PRODUCTS
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:justify-between px-4 md:px-8 py-4">
            <div className="flex items-center gap-2">
              <img
                src="./assets/cart.png"
                alt="cartimg"
                className="w-4 h-4 sm:w-6 sm:h-6 md:h-7 md:w-7 "
              />
        ...
        <div className="absolute left-0 top-0 h-full w-[15%] sm:w-[10%] flex items-center border-r-[#D29A5A] border-r-8 bg-[#130F0CCC] z-[999]">
          <img
