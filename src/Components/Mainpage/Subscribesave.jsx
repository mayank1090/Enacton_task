      ...
      <div className="w-full pt-16 relative pl-[15%] sm:pl-[10%] bg-black">
        ...
        <div className="relative w-full pt-16">
          ...
          <div className=" w-full flex absolute bottom-[10%] z-10 flex-col pl-8 sm:pl-10 md:pl-12" >
           <div className="w-[45%] border-white border-b-4">
           <p className="pb-4 text-white text-xl  sm:text-2xl md:text-3xl">SIGN UP SPECIAL PROMOTIONS</p>
            ...
            <div className="w-full flex gap-3 pt-4 sm:pt-6 md:pt-8">
                <input type="text" placeholder="Enter email address" className="w-[40%] p-2 text-xs sm:text-base md:text-lg bg-transparent outline-none border-2 border-white text-white" />
                <button className="px-6 sm:px-10 py-2 text-xs sm:text-base md:text-lg bg-[#D29A5A]">Subsribe</button>
            </div>
          </div>
        </div>
      </div>
